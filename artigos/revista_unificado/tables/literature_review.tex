\begin{table*}[!t]
\centering
\caption{Representative observation-driven studies at intra-hour and short
...
Up to 5~min; six pyranometers on four partly cloudy days \\
...
Irradiance, temperature, relative humidity, and wind speed; wavelet-packet decomposition &
...
ICEEMDAN decomposition of the original sequence before temporal modeling &
ICEEMDAN--TimesNet &
...
Radiation history, month number, and exogenous series according to formulation &
