...
\subsection{Block A: data contract and temporal windows}
...
\subsection{Block B: matched model development}
...
uses a one-hot representation. A single global model is fitted across sites,
...
\subsection{Block C: physical consistency and evaluation}
