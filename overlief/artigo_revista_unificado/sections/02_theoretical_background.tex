...
(FFT) of sample $b$ at frequency bin $f$ and channel $c$. For
leakage-controlled inference, the implemented variant averages only over the
channels of the same sample,
\begin{equation}
  A_{b,f}
  =
  \frac{1}{C_x}
