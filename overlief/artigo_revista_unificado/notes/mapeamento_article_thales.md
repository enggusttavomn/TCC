# Uso do `article_thales.pdf` como referência estrutural

O artigo `../article_thales.pdf` é uma referência de organização, profundidade
...
| Elemento no `article_thales.pdf` | Conteúdo real | Aplicação no artigo unificado |
|---|---|---|
...
No `article_thales.pdf`, a Tabela 13 utiliza uma amostra por hora, 120 amostras
